...
class ConflictoLiquidacionModel(models.Model):


    fechaInicioLiquidacion  = models.DateTimeField(null=True, blank=True)
    fechaFinalLiquidacion= models.DateTimeField(null=True, blank=True)
    diasDeVacaciones=models.CharField(max_length=255, null=True, blank=True)
